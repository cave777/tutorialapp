...
def newsletter_unsubscribe(request):
    ...
    if form.is_valid():
        ...
        if NewsletterUser.objects.filter(email=instance.email).exists():
            ...
            messages.success(request, 'Your email has been deleted', 'alert alert-success alert-dismissible')
            ...
            messages.warning(request, 'Your email is not registered', 'alert alert-warning alert-dismissible')
